...
rpm -q rpm-build rsync python2 python-sqlobject

if [ $? -ne 0 ]; then
	echo
	echo "ERROR: Build dependencies not met."
	echo
	echo "  Please ensure that the 'rpm-build', 'rsync', 'python2', and 'python-sqlobject'"
	echo "  rpms are installed before building."
	echo
	echo "  NOTE:"
	echo "    If your RPM repositories do not include 'python-sqlobject', you may install it"
	echo "    using pip:"
	echo
