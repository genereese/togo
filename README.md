...
##### Using yum
```
$ sudo yum install https://github.com/genereese/togo/releases/download/togo-3.0r5/togo-3.0-5.noarch.rpm
```

##### Using dnf
```
$ sudo dnf install https://github.com/genereese/togo/releases/download/togo-3.0r5/togo-3.0-5.noarch.rpm
```
